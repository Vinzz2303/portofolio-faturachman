...
const dashboardTranslations = {
  en: {
    ...
    decisionIntelligenceLabel: 'Decision support',
  ...
  id: {
    ...
    decisionIntelligenceLabel: 'Bantuan memahami keputusan',
